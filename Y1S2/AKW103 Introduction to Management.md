...
```mermaid
graph TD
    P[Planning: Strategic Vision & Goals] --> O[Organizing: Structure & Resources]
    O --> L[Leading: Influence & Inspiration]
    L --> C[Controlling: Monitor & Improve]
    C --> P
    subgraph Integrated Process
    P
    O
    L
    C
